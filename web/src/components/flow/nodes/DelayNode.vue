...
import { ClockIcon, LoaderIcon, CheckCircleIcon, XCircleIcon } from 'lucide-vue-next'
...
<template>
  ...
  >
    ...
    <div class="node-content">
      <span class="node-label">{{ data?.name || '延迟' }}</span>
      <span class="node-type">等待</span>
    </div>
...
@keyframes pulse {
  0%, 100% { box-shadow: 0 0 0 3px rgba(100, 116, 139, 0.3); }
  50% { box-shadow: 0 0 0 6px rgba(100, 116, 139, 0.2); }
}
...
.node-running .exec-indicator { color: #64748b; }
