...
import { ShuffleIcon, LoaderIcon, CheckCircleIcon, XCircleIcon } from 'lucide-vue-next'
...
<template>
  <div
    class="flow-node transform-node"
    :class="{
  ...
  >
    ...
    <div class="node-content">
      <span class="node-label">{{ data?.name || '转换' }}</span>
      <span class="node-type">数据转换</span>
    </div>
...
.node-running .exec-indicator { color: #8b5cf6; }
