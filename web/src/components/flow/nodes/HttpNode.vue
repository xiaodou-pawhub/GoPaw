...
import { GlobeIcon, LoaderIcon, CheckCircleIcon, XCircleIcon } from 'lucide-vue-next'
...
<template>
  ...
  >
    ...
    <div class="node-content">
      <span class="node-label">{{ data?.name || 'HTTP' }}</span>
      <span class="node-type">HTTP 请求</span>
    </div>
...
@keyframes pulse {
  0%, 100% { box-shadow: 0 0 0 3px rgba(14, 165, 233, 0.3); }
...
.node-running .exec-indicator { color: #0ea5e9; }
